...
const Contact = () => {
  return (
    <div name="contact" className='w-full h-screen bg-sand  text-bearbrown'>
        ...
        <div className='flex justify-center items-center'>
          <form action="https://getform.io/f/f9e9d92f-ff6b-4a6d-ab7f-0b171d5756d0" method="POST" className="flex flex-col w-full md:w-1/2">
            ...
            <textarea name="messgae" rows="10" placeholder="Enter your message" className='p-2 border-2 bg-white rounded-md focus:outline-none'></textarea>
              <button className='bg-babyavo text-white h-24 w-24 my-8 mx-auto flex items-center justify-center rounded-full hover:scale-110 hover:line-through duration-300'>Let's Talk
              </button>
